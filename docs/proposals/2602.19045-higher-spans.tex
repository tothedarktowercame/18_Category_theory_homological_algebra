...
\end{itemize}
\subsection*{Batch 6 linkage}
\begin{itemize}
  \item This entry anchors the next PlanetMath CT batch, so we cross-reference the upcoming proposals for arXiv:2602.01292, 2602.02218, 2602.03149, and 2602.04049 when wiring the encyclopedia graph.
  \item Duplicate checks relied on grepping \texttt{docs/proposals/} because \texttt{pm-full-dictionary.json} is not available on this machine.
\end{itemize}
